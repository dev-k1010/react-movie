...
export default function SuaPhim() {
  const { upDatePhim, errUpdatePhim } = useSelector(
  ...
  return (
    <div className="SuaPhim p-3">
      <p className="font-bold text-xl mb-3">
        Sửa phim: {lichChieuPhim.tenPhim}
      </p>
      <div className="flex">
        <div>
        ...
        <form onSubmit={handleSubmitForm} className="flex-1">
          ...
          <div className="flex mb-2">
            ...
            {lichChieuPhim.dangChieu === undefined ? (
              ""
            ) : (
              <Switch
                defaultChecked={lichChieuPhim.dangChieu}
                onChange={(checked) => setValue("dangChieu", checked)}
              />
            )}
            <p className="m-0 text-red-500 h-5 pl-2 w-60"></p>
          </div>
          ...
          <div className="flex mb-2">
            ...
            {lichChieuPhim.sapChieu === undefined ? (
              ""
            ) : (
              <Switch
                defaultChecked={lichChieuPhim.sapChieu}
                onChange={(checked) => setValue("sapChieu", checked)}
              />
            )}
            <p className="m-0 text-red-500 h-5 pl-2 w-60"></p>
          </div>
          ...
          <div className="flex mb-2">
            ...
            {lichChieuPhim.hot === undefined ? (
              ""
            ) : (
              <Switch
                defaultChecked={lichChieuPhim.hot}
                onChange={(checked) => setValue("hot", checked)}
              />
            )}
            <p className="m-0 text-red-500 h-5 pl-2 w-60"></p>
          </div>
          ...
          <div className="flex mb-2">
            ...
            <img
              src={urlHinhAnh || lichChieuPhim.hinhAnh}
              alt="..."
